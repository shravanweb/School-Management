      ...
      <div className="container footer-inner">
        <div className="footer-brand">
          ...
          <p className="footer-desc">
            Inspiring excellence since 2005. We nurture curious minds through
            quality education, caring teachers, and a vibrant K–12 learning community.
          </p>
        ...
        <div className="footer-col footer-contact">
          ...
          <ul className="footer-contact-list">
            ...
            <li>
              ...
              <a href="tel:+914023456789">(040) 2345-6789</a>
            </li>
            <li>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
              ...
              <a href="mailto:info@masterminds.edu">info@masterminds.edu</a>
            </li>
            <li>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
